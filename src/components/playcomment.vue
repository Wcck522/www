<template>
	<div class="con_item">
		<div class="con_head">
			<img :src="comments.avatarUrl" alt="">
		</div>
		<div class="con_wrap">
			<div class="con_header">
				<span class="con_meta">
					<span class="con_user">
						<span>{{comments.nickname}}
						</span>
					</span>
					<!-- <div class="con_time"></div> -->
				</span>
				<span class="con_like">
					<span class="con_likearea">
					<span class="con_count">{{item.likedCount}}</span>
					<i class="con_likeicon">
...
<script>
	export default{
		...
		computed:{
			// vip:function(){
			// 	let vnum;
			// 	if(this.comments.vipRights.redVipLevel){
			// 		vnum=this.comments.vipRights.redVipLevel;
			// 	}else{
			// 		vnum="";
			// 	}
			// 	return vnum;
...
<style lang="less">
	...
	.level4{
		background-image: url(//p6.music.126.net/obj/wo3DlcOGw6DClTvDisK1/4213923065/dc4e/2b9c/7677/20a6644….png);
	}
	.level5{
		background-image: url(//p5.music.126.net/obj/wo3DlcOGw6DClTvDisK1/4213923094/81eb/9288/68a5/a427a0d….png);
	}
</style>
